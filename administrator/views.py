...
from .models import Administrator, Banner, SiteAddress, SiteConfiguration, SocialMedia, Testimonial, Visitor
from administrator.resources import ShippingFeeZone, Country
